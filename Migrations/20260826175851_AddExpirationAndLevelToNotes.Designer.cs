...
namespace DotNetCoreSqlDb.Migrations
{
    ...
    [Migration("20260826175851_AddExpirationAndLevelToNotes")]
    partial class AddExpirationAndLevelToNotes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotNetCoreSqlDb.Models.Conversations", b =>
                {
                    ...
                    b.Property<Guid?>("LastMessageSeenByStudentId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("LastMessageSeenByTeacherId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DotNetCoreSqlDb.Models.EmailPaymentsLog", b =>
                {
                    ...
                    b.Property<bool?>("HandledAutomatically")
                        .HasColumnType("bit");
                    ...
                    b.Property<Guid?>("StudentBalanceTransactionLogId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DotNetCoreSqlDb.Models.User", b =>
                {
                    ...
                    b.Property<byte[]>("ImpersonationPasswordHash")
                        .HasColumnType("varbinary(max)");

                    b.Property<byte[]>("ImpersonationPasswordSalt")
                        .HasColumnType("varbinary(max)");
                    ...
                    b.Property<DateTime?>("PaswordSetDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("DotNetCoreSqlDb.Models.ZoomMeetings", b =>
                {
                    ...
                    b.Property<DateTime?>("FirstMutualPresenceTime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("DotNetCoreSqlDb.Models.EmailPaymentsLog", b =>
                {
                    b.HasOne("DotNetCoreSqlDb.Models.StudentBalanceTransactionLog", "StudentBalanceTransactionLog")
                        .WithMany()
            ...
            modelBuilder.Entity("DotNetCoreSqlDb.Models.Messages", b =>
                {
                    b.HasOne("DotNetCoreSqlDb.Models.Conversations", "Conversation")
                        .WithMany()
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DotNetCoreSqlDb.Models.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("DotNetCoreSqlDb.Models.ZoomMeetingLog", b =>
                {
                    ...
                    b.HasOne("DotNetCoreSqlDb.Models.ZoomMeetings", "ZoomMeeting")
                        .WithMany()
